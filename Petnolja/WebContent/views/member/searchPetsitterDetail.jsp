  ...
  <!--왼쪽면 끝-->
    ...
    <div class="wrap wrap3">
        ...
        <div style="text-align: center;">
          ...
          <button type="button" class="btn btn-primary" style="width:200px;margin-bottom:5px" onclick="location.href='<%=contextPath%>/views/member/askToPetsitter.jsp'"><img src="../../resources/images/member/messenger.png" class="buttonImg">&nbsp;&nbsp;&nbsp;펫시터에게 문의하기</button><br>
        </div>
        <br><br>
         <!-- 공유하기 버튼 클릭시 모달 실행 -->
        ...
        <!--예약 area-->
          <div style="text-align:center;"><hr>
            ...
            <div style="line-height:190%">
                ...
                <button type="button" class="btn btn-danger" style="width:200px;margin-bottom:5px" onclick="location.href='<%=contextPath%>/views/member/reserveProceed.jsp'">&nbsp;&nbsp;&nbsp;예약하기</button><br>
              </div>
            </div>
          <hr>
          <!--지도 area-->
