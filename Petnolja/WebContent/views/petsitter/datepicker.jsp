    ...
    <head>
        ...
        <style>    
            ...
            *{margin:0;padding:0;font-family:"Malgun Gothic","맑은 고딕",Dotum,"돋움",Arial,sans-serif}
            ...
            .searchBox tbody th{padding:20px 10px 20px 35px;font-size:14px;font-weight:bold;text-align:left;vertical-align:top;border:none;background:#E1F0FA;margin: 0%; }
            .searchBox tbody td{padding:12px 10px 12px 25px;margin:0px;border:none;background-color:#E1F0FA}
            ...
            .searchDate li .chkbox2 label{display:block;width:72px;height:26px;font-size:14px;font-weight:bold;color:#fff;text-align:center;line-height:25px;text-decoration:none;cursor:pointer;background:#C7E3F6}
            .searchDate li .chkbox2.on label{background:#3498DB}
