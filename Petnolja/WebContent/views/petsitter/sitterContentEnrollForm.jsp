...
<br><br>
    <div id="outer">
        ...
        <form action="<%=contextPath %>/contentEnroll.sitn" id="enroll-form" method="post" enctype="multipart/form-data">
            <div id="file-area">
            ...
            <div class="form-group">
                <span>
                    <b>시터 소개글 제목*</b> &nbsp;&nbsp;
                    <input type="text" name="title" class="form-control"  placeholder="예) 한강산책 가능한 경력많은 펫시터입니다" required>
                </span>
                <br>
                <span>
                    <b>본문내용 *</b> &nbsp;&nbsp;
                    <textarea name="selfIntro" id="comment" style="width:100%; height: 200px; resize: none; border:1px solid lightgray"  placeholder="시터님과 환경에 대한 소개를 1000자이내로 자유롭게 적어주세요" required></textarea>
