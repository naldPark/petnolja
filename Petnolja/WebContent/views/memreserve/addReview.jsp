...
<div id="popup" class="hide">
  <div class="findContent">
    ...
    <div><img src="<%=contextPath%>/<%=mr.getPath()%>" style="height: 80px; float:left; margin-right:20px;"></div>
    <div style="margin-top:15px; margin-bottom: 25px; text-align: left;">
        
        <h6><%=mr.getSitterTitle()%></h6>
        <p>펫시터: <%=mr.getMemName()%></p>
    </div>
    <hr>
    ...
    <div style="height: 300px; text-align: center;"><h6>어떤점이 좋았나요 ?</h6>
        <div class="form-group">
       	  	<input type="hidden" name ="reserveNo" value="<%=mr.getReserveNo()%>">
